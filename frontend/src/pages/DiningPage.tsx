...
const STATIC_FOOD: FoodItem[] = [
  { id: 'f1', category_id: 'rice', name: 'Jollof Rice & Chicken', description: 'Aromatic tomato-based rice cooked to perfection, served with tender grilled chicken.', price: 850, image: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f2', category_id: 'rice', name: 'Fried Rice & Chicken', description: 'Stir-fried rice with vegetables, egg and choice of protein.', price: 800, image: 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f3', category_id: 'rice', name: 'Coconut Rice', description: 'Fragrant rice cooked in rich coconut milk, served with fried plantain.', price: 750, image: 'https://images.unsplash.com/photo-1596560548464-f010549b84d7?w=600&q=80', is_vegetarian: true, is_available: true },
  { id: 'f4', category_id: 'swallow', name: 'Pounded Yam & Egusi Soup', description: 'Smooth pounded yam served with rich egusi soup loaded with assorted meat.', price: 900, image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f5', category_id: 'swallow', name: 'Eba & Okra Soup', description: 'Cassava fufu with thick okra soup and fried fish.', price: 850, image: 'https://images.unsplash.com/photo-1574484284002-952d92456975?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f6', category_id: 'soup', name: 'Banga Soup', description: 'Rich and flavorful palm fruit soup with assorted proteins.', price: 950, image: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f7', category_id: 'soup', name: 'Ofe Onugbu', description: 'Bitter leaf soup slow-cooked with ofe onugbu and cocoyam.', price: 900, image: 'https://images.unsplash.com/photo-1569050467447-ce54b3bbc37d?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f8', category_id: 'snack', name: 'Peppered Meat', description: 'Succulent cuts of beef and offal, marinated and grilled in a spicy pepper sauce.', price: 700, image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f9', category_id: 'snack', name: 'Chicken Shawarma', description: 'Toasted flatbread filled with seasoned chicken, fresh veggies and garlic sauce.', price: 600, image: 'https://images.unsplash.com/photo-1627308595229-7830a5c91f9f?w=600&q=80', is_vegetarian: false, is_available: true },
  { id: 'f10', category_id: 'snack', name: 'Spring Rolls (6 pcs)', description: 'Crispy spring rolls stuffed with vegetables and served with sweet chilli sauce.', price: 500, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80', is_vegetarian: true, is_available: true },
  ...
  { id: 'f12', category_id: 'drink', name: 'Chapman Cocktail', description: 'The classic Nigerian cocktail with a blend of fruity flavours.', price: 600, image: 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=600&q=80', is_vegetarian: true, is_available: true },
]
